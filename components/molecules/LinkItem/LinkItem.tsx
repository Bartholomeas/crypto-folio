		...
		return (
			<div className='relative flex-col gap-sm h-[3rem]'>
				<button
					...
					className='flex items-center justify-between min-w-[3rem] w-full h-[3rem] px py-[0.6rem] bg-baseLight text-xs font-semibold text-fontLight rounded-lg cursor-pointer hover:bg-baseVeryLight transition-colors'>
					{linkKey}
				...
				<ul
					...
					} absolute t-[3rem] origin-top transition-transform z-[1000] bg-baseVeryLight rounded-lg  flex flex-col gap-[0.3rem]`}>
					{allLinks.map(link => {
						...
						return (
							<li key={uuidv4()} className='z-1000'>
								<a
									...
									href={link}
									target='blank'
									className='flex items-center justify-center min-w-[3rem] w-fit h-[3rem] px py-[0.6rem] bg-baseVeryLight text-xs font-semibold text-fontLight rounded-lg cursor-pointer hover:bg-baseVeryLight transition-colors'>
									{linkKey}
								</a>
							</li>
						);
